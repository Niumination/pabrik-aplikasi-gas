/**
 * N5 Digest Reporter — Code.gs
 * Mesin ringkasan multi-sumber + email HTML + trigger helpers.
 *
 * WAJIB dipasang bersama setup.gs di project Apps Script yang sama
 * (setup.gs mendefinisikan DIGEST_SETUP + onOpen + setupDigestSystem).
 *
 * Urutan file tidak masalah — Apps Script menggabungkan semua .gs.
 */
